...
macro(simple_parallel_setup_options)
    ...
    if(NOT PROJECT_IS_TOP_LEVEL OR simple_parallel_PACKAGING_MAINTAINER_MODE)
        ...
        option(simple_parallel_FORCE_FIND_PACKAGE "Force find local package via `find_package`" ON)
    else()
        ...
        option(simple_parallel_ENABLE_CPPCHECK "Enable cpp-check analysis" ON)
        option(simple_parallel_ENABLE_TESTING "Enable Testing" ON)
        option(simple_parallel_FORCE_FIND_PACKAGE "Force find local package via `find_package`" OFF)
    endif()
