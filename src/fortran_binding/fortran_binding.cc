...
extern "C" void s_p_f_ctx_add_reduce_area(par_ctx_fortran_binding *ctx,
  ...
  if (mpi_type == cfi_type_2_mpi_type.end()) {
    static const std::map<CFI_type_t, const char *> all_type_names{
        ...
        {CFI_type_half_float, "CFI_type_half_float"},
        {CFI_type_bfloat, "CFI_type_bfloat"},
        {CFI_type_float, "CFI_type_float"},
        {CFI_type_double, "CFI_type_double"},
        {CFI_type_extended_double, "CFI_type_extended_double"},
        {CFI_type_long_double, "CFI_type_long_double"},
        {CFI_type_float128, "CFI_type_float128"},
        {CFI_type_half_float_Complex, "CFI_type_half_float_Complex"},
        {CFI_type_bfloat_Complex, "CFI_type_bfloat_Complex"},
        {CFI_type_float_Complex, "CFI_type_float_Complex"},
        {CFI_type_double_Complex, "CFI_type_double_Complex"},
        {CFI_type_extended_double_Complex, "CFI_type_extended_double_Complex"},
        ...
        {CFI_type_char16_t, "CFI_type_char16_t"},
        {CFI_type_char32_t, "CFI_type_char32_t"},
        {CFI_TYPE_LAST, "CFI_TYPE_LAST"},
