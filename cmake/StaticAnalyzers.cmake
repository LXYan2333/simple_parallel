macro(simple_parallel_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
    ...
    if("${CPPCHECK_OPTIONS}" STREQUAL "")
      ...
      set(CMAKE_CXX_CPPCHECK
          ...
          --inconclusive
          # false positive in this project
...
macro(simple_parallel_enable_clang_tidy target WARNINGS_AS_ERRORS)
...
macro(simple_parallel_enable_include_what_you_use)
